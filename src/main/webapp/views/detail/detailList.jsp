               ...
               <table class="BookingList-table"
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td class="book_no"><a href="<%=request.getContextPath()%>/Review/ReviewListServlet.do">리뷰작성</a></td>
                     </tr>
                     <%
                     }
                     %>
               ...
               <table class="OrderList-table"
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td class="book_no"><a href=""
                           style="text-decoration: none;" onclick="location.assign('<%=request.getContextPath()%>/Review/ReviewListServlet.do')">리뷰작성</a></td>
                     </tr>
                     <%
                     }
                     %>
