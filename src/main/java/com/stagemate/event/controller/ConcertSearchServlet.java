 ...
 */
@WebServlet("/event/concertsearch.do")
public class ConcertSearchServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ConcertSearchServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(theme==null||theme.equals("전체")) {
			concert = new EventService().searchAllEventConcert(cPage, numPerpage,searchtext);
			totalData = new EventService().searchAllEventCountConcert(searchtext);
