...
public class PlayListService {
   ...
   //예매내역서 가져오기 
//   public List<Detail> selectPlayDetail(String userId, String day, String yyyy, String mm, String status){
//      Connection conn=getConnection();
//      List<Detail> result=dao.selectPlayDetailCondition(conn,userId, day, yyyy, mm, status);
//      close(conn);
//      return result;
//   }
