 ...
 */
@WebServlet("/Detail/StoreDetailInfoServlet")
public class StoreDetailInfoServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		StoreDetailOrderDlv storeDetailOrderDlv = new StoreListService().selectStoreDetailOrderDlv(userId, checkNo);
		request.setAttribute("StoreDetailOrderDlv", storeDetailOrderDlv);
		
		request.getRequestDispatcher("/views/detail/play_store_detail.jsp").forward(request, response);  
	}
