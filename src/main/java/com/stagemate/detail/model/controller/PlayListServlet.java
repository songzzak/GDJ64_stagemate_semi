...
public class PlayListServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<StoreDetail> stores  = new StoreListService().selectStoreDetailCondition(userId, "1", "", "", "배송 중", 1, 10, "DESC");
		request.setAttribute("StoreList", stores );
		
		int totalCount = new PlayListService().selectPlayDetailCount(userId, "1", "", "", "전체");
