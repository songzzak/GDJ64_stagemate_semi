 ...
 */
@WebServlet("/Detail/PlayDetailInfoServlet")
public class PlayDetailInfoServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<DetailTicketList> ticketList = new ArrayList<>();
		if (!detailInfo.getEsNo().equals("")) {
			ticketList = new PlayListService().selectPlayDetailTicketList(checkNo);
		}
		
		request.setAttribute("TicketList", ticketList);
		
		request.getRequestDispatcher("/views/detail/play_detail.jsp").forward(request, response);  
	}
