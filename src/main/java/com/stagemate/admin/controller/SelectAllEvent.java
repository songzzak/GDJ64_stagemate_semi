...
public class SelectAllEvent extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Event> e=new EventService().listAllEvent(cPage,numPerpage);
		request.setAttribute("event", e);
		int totalData=new EventService().selectEventCount();
